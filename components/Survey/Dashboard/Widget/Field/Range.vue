...
<template>
    <div class="chart" v-if="row.field.type == 'NPS'">
        <SurveyDashboardWidgetChartItem :row="row" :data="averageSets()" type="line"></SurveyDashboardWidgetChartItem>
    </div>
    <div class="chart flex" v-else>
        <div>
            <SurveyDashboardWidgetChartItem :row="row" :data="totalSets()" type="pie"></SurveyDashboardWidgetChartItem>
        </div>
